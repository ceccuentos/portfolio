        ...
        <div className="container py-5" id="aboutme" >
            <div className="row">
                ...
                <div className="col-lg-6 col-xm-12">
                    ...
                    <br/> He dedicado mi vida profesional a liderar equipos para resolver problemas de negocios mediante la tecnología, 
                    es así como he participado en diversos proyectos tecnológicos en los he adaptado la tecnología con lsa necesidades del cliente. 
                    <br/> 
